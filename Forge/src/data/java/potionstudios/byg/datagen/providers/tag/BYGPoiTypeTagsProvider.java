...
public class BYGPoiTypeTagsProvider extends PoiTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        tag(BYGPOITypeTags.ACQUIRABLE_JOB_SITE).add(BYGPoiTypes.FORAGER.getResourceKey());
        tag(PoiTypeTags.ACQUIRABLE_JOB_SITE).addTag(BYGPOITypeTags.ACQUIRABLE_JOB_SITE);
    }
}
